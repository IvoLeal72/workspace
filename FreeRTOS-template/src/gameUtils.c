...
static void loadGameSprites(){
	...
	unsigned char E_T[] = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x0E, 0x0E, 0x04 };
	unsigned char T_E[] = { 0x00, 0x0E, 0x0E, 0x04, 0x00, 0x00, 0x00, 0x00 };
	unsigned char T_T[] = { 0x00, 0x0E, 0x0E, 0x04, 0x00, 0x0E, 0x0E, 0x04 };
	unsigned char E_C[] = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x0E, 0x1F, 0x0A };
	unsigned char C_E[] = { 0x00, 0x0E, 0x1F, 0x0A, 0x00, 0x00, 0x00, 0x00 };
	unsigned char T_C[] = { 0x00, 0x0E, 0x0E, 0x04, 0x00, 0x0E, 0x1F, 0x0A };
	unsigned char C_T[] = { 0x00, 0x0E, 0x1F, 0x0A, 0x00, 0x0E, 0x0E, 0x04 };
	RTOS_LCD_CreateChar(0, E_E);
	RTOS_LCD_CreateChar(1, E_T);
	RTOS_LCD_CreateChar(2, T_E);
	RTOS_LCD_CreateChar(3, T_T);
	RTOS_LCD_CreateChar(4, E_C);
	RTOS_LCD_CreateChar(5, C_E);
	RTOS_LCD_CreateChar(6, T_C);
	RTOS_LCD_CreateChar(7, C_T);
}
...
bool Game_Update(){
	...
	for(int y=0; y<2; y++){
		for(int x=0; x<16; x++){
			RTOS_LCD_LocatedChar(y, x, displayMap[x][y], false);
		}
	}
